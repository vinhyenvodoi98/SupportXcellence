  ...
  const steps = [
    {
      title: 'Round Details',
      description:
        'What is round name, Funding period, Which chain do you want to raise funds on?',
    },
    {
    ...
    },
    {
      ...
      description:
        'Review round information and fill in other necessary details',
    },
  ];
          ...
          <div className='grid grid-rows-3 gap-4'>
            ...
            {current + 1 === steps.length ? (
              <div className='grid grid-cols-2 gap-4'>
                <button onClick={prev} className='btn btn-active'>
                  Previous
                </button>
                <button className='btn btn-active btn-success'>Submit</button>
              </div>
            ) : current === 0 ? (
              <button onClick={next} className='btn btn-active btn-success'>
                Next
              </button>
            ) : (
              <div className='grid grid-cols-2 gap-4'>
