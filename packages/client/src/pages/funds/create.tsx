      ...
      <div className='grid grid-cols-4 gap-8'>
              ...
              <div className="card w-full border rounded">
                <div className="card-body">
                  <div className="flex gap-2">
                    ...
                    <Image width={20} height={20} src="/svg/verify.svg" alt="verify" />
                  </div>
            ...
            {isFetchSuccess && token &&
              <div>
                <div className="form-control w-full">
                  ...
                  <input onChange={(e) => setVaultTokenName(e.target.value)} type="text"
                ...
                <div className="form-control w-full">
                  ...
                  <input onChange={(e) => setVaultTokenSymbol(e.target.value)} type="text"
        ...
        <div className='shadow-xl rounded-box border col-span-1 p-8 max-h-72 sticky top-24'>
          <div className='grid grid-rows-3 gap-4'>
            ...
            <p>
              Creating a new vault is the initial step in establishing a secure and organized digital storage space
            </p>
            <button onClick={() => createFund()} className='btn btn-active btn-success'>Create</button>
          </div>
        </div>
      </div>
    </Layout>
